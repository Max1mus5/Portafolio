...
const AboutMe = ({ darkMode }) => {
  ...
  // Helper to render social icons with proper dark/light mode classes
  const renderSocialIcons = () => (
    <div className="effect aboutme-icons">
      ...
      >
        <svg className={darkMode ? "github" : "github_ligth"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <a 
        ...
        rel="noopener noreferrer"
      >
        <svg className={darkMode ? "linkedin" : "linkedin-ligth"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div className="email-icon">
        <button 
          ...
          onClick={copiedEmail}
        >
          <svg className={darkMode ? "email-svg" : "email-svg-ligth"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <div className={darkMode ? "copied" : "copied-light"}>
  ...
  // Helper to render the description with highlighting
  const renderHighlightedDescription = () => {
    ...
    return (
      <p 
        ...
        id={darkMode ? "aboutme-little-description-content" : "aboutme-little-description-ligth"}
      >
        <span className="description-segment">
          ...
          {technologies.map((tech, index) => (
            <React.Fragment key={tech}>
              <span className="highlight-tech animated-span">{tech}</span>
              {index < technologies.length - 1 ? 
                <span className="tech-separator animated-span">, </span> 
                : <span className="tech-separator animated-span"> </span>
              }
            </React.Fragment>
          ))}
  ...
  return (
    <section className="aboutme-section" id="aboutme">
      <div className="aboutme-grid-section">
        ...
        <button 
          className={darkMode ? "button effect" : "button ligthModePresentation"} 
          data-text={t('about.title.role')}
        >
        ...
        <div className="aboutme-little-description">
          {/* Default description */}
          <p 
            className={`default-description effect ${darkMode ? "aboutme-little-description-content aboutme-little-description-dark" : "aboutme-little-description-ligth"}`}
          >
