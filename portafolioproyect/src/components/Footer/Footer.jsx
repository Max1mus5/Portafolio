const Footer = ({ darkMode, emailcopied, handleEmailCopy }) => {
  return (
    <>
      <footer className="footer" id={darkMode ? "light" : "dark"}> 
        ...
        <div className="footer-contact">
          <div className="footer-icons">
            <div className="email-icon">
              <button className="contact-icon email" title="Copiar Email" onClick={handleEmailCopy}>
              ...
              <div className={darkMode ? "copied-light" : "copied"}>{emailcopied ? "Copiado" : ""}</div>
            </div>
