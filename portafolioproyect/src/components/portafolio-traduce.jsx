      ...
      {isDarkMode ? (
        ...
        <nav id="main-navbar">
            ...
            <div className="navbar-features">
              <button onClick={language} title="Traduce to Spanish"><span className="traduce-icon">
...
<g id="SVGRepo_iconCarrier"> <path d="M5 8L10 13M4 14L10 8L12 5M2 5H14M7 2H8M12.913 17H20.087M12.913 17L11 21M12.913 17L15.7783 11.009C16.0092 10.5263 16.1246 10.2849 16.2826 10.2086C16.4199 10.1423 16.5801 10.1423 16.7174 10.2086C16.8754 10.2849 16.9908 10.5263 17.2217 11.009L20.087 17M20.087 17L22 21" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/> </g>

</svg>
</span></button>
              <button title="Switch theme" onClick={toggleDarkMode} ><span className="sun-theme-icon">
              <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
...
<g id="SVGRepo_iconCarrier"> <circle cx="12" cy="12" r="5" stroke="#d69e2e" stroke-width="1.5"/> <path d="M12 2V4" stroke="#d69e2e" stroke-width="1.5" stroke-linecap="round"/> <path d="M12 20V22" stroke="#d69e2e" stroke-width="1.5" stroke-linecap="round"/> <path d="M4 12L2 12" stroke="#d69e2e" stroke-width="1.5" stroke-linecap="round"/> <path d="M22 12L20 12" stroke="#d69e2e" stroke-width="1.5" stroke-linecap="round"/> <path d="M19.7778 4.22266L17.5558 6.25424" stroke="#d69e2e" stroke-width="1.5" stroke-linecap="round"/> <path d="M4.22217 4.22266L6.44418 6.25424" stroke="#d69e2e" stroke-width="1.5" stroke-linecap="round"/> <path d="M6.44434 17.5557L4.22211 19.7779" stroke="#d69e2e" stroke-width="1.5" stroke-linecap="round"/> <path d="M19.7778 19.7773L17.5558 17.5551" stroke="#d69e2e" stroke-width="1.5" stroke-linecap="round"/> </g>

</svg>
</span></button>
              <a href="https://drive.google.com/file/d/1hf0yYf3hkurcMUsJNodRmKFDWQm6Savl/view?usp=sharing" target='_blank'><span className="icon_download"> 
              <svg fill="#000000" width="30px" height="30px" viewBox="-1.6 -1.6 19.20 19.20" id="download-cloud-16px" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.00016" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)">
        ...
        <section className="projects-section"  id="projects">
          <div className="project">
            <div className="header-project">
              ...
              <a href="https://mastervault.vercel.app/" title="MasterVault Demo"><span target="_blank" className="link_icon">
...
<path d="M14 7H16C18.7614 7 21 9.23858 21 12C21 14.7614 18.7614 17 16 17H14M10 7H8C5.23858 7 3 9.23858 3 12C3 14.7614 5.23858 17 8 17H10M8 12H16" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <section className="portafolio-scroll back">
        <nav id="main-navbar">
            ...
            <div className="navbar-features">
              <button onClick={language} title="Traduce To Spanish"><span className="traduce-icon ligthModeTraduce">
              <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
...
<path d="M3.32031 11.6835C3.32031 16.6541 7.34975 20.6835 12.3203 20.6835C16.1075 20.6835 19.3483 18.3443 20.6768 15.032C19.6402 15.4486 18.5059 15.6834 17.3203 15.6834C12.3497 15.6834 8.32031 11.654 8.32031 6.68342C8.32031 5.50338 8.55165 4.36259 8.96453 3.32996C5.65605 4.66028 3.32031 7.89912 3.32031 11.6835Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              ...
              <a className="ligth_Mode" href="https://drive.google.com/file/d/1hf0yYf3hkurcMUsJNodRmKFDWQm6Savl/view?usp=sharing" target='_blank'><span className="icon_download"><svg fill="white" width="30px" height="30px" viewBox="-1.6 -1.6 19.20 19.20" id="download-cloud-16px" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.00016" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)">
...
<path d="M14 7H16C18.7614 7 21 9.23858 21 12C21 14.7614 18.7614 17 16 17H14M10 7H8C5.23858 7 3 9.23858 3 12C3 14.7614 5.23858 17 8 17H10M8 12H16" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <section className="tecnologies-section" id="tecnologies">
         ...
         <div className={darkMode ? "tecnologies tech-ligth tools" :"tecnologies tools tech-ligth"}>
            ...
            <div className="icon-grid-view">
              <ul>
              <li><i className="icon git"></i> <img className="icon-img-tech" src={git} alt="Git" /></li>
              <li><i className="icon code"></i> <img className="icon-img-tech" src={postman} alt="Post Man" /></li>
              <li><i className="icon figma"></i> <img className="icon-img-tech" src={figma} alt="Figma" /></li>
            </ul>
            </div>
          </div>
        </section>
