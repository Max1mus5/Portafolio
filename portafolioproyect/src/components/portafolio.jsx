      ...
      {isDarkMode ? (
        ...
        <nav id="main-navbar">
            ...
            <div className="navbar-features">
              <button title="Traduce"><span className="material-symbols-outlined traduce-icon">
translate
</span></button>
              <button title="Switch theme" onClick={toggleDarkMode} ><span className="material-symbols-outlined sun-theme-icon">
wb_sunny
</span></button>
              <a href="https://drive.google.com/file/d/1SWq582r6thFDvr3MjDf5U40-nnWDw9by/view?usp=sharing" target='_blank'><span className="material-symbols-outlined icon_download">cloud_download</span>Descargar CV</a> 
            </div>
        </nav>
        ...
        <div className="presentation">
          ...
          <div className="effect aboutme-icons">
              ...
              <a className="contact-icon " title="Linkedin" href="https://www.linkedin.com/in/jeronimo-riveros" target="_blank">
                ...
                <path className="linkedin-background" clip-rule="evenodd" d="M20 1C21.6569 1 23 2.34315 23 4V20C23 21.6569 21.6569 23 20 23H4C2.34315 23 1 21.6569 1 20V4C1 2.34315 2.34315 1 4 1H20ZM20 3C20.5523 3 21 3.44772 21 4V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3H20Z"/>
      ...
      <section className="portafolio-scroll">
        <nav id="main-navbar">
            ...
            <div className="navbar-features">
              <button title="Traduce"><span className="material-symbols-outlined traduce-icon ligthModeTraduce">
translate
</span></button>
